            ...
            <div class="row d-flex">
                <div class="col-lg-6">
                    <div class="card1 pb-5">
                        ...
                        <div class="row px-3 justify-content-center"> <img
                                src="https://image.freepik.com/free-vector/charity-icons-flat-round-set_1284-34021.jpg"
                                class="image"> </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="card2 card border-0 px-4 py-5">
                        <div class="row mb-4 px-3">
                            <h6 class="mb-0 mr-4 mt-2">Silahkan login</h6>
                        </div>
                        <hr>
                        ...
                        <div class="row mb-4 px-3"> <small class="font-weight-bold">Tidak punya akun? <a
                                    class="text-danger" href="pilihakun.html">Registrasi</a></small> </div>
                    </div>
                </div>
            </div>
