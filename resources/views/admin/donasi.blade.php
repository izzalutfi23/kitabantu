                            ...
                            <table id="example" class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{url('/dashboard/detaildonasi/'.$data->id)}}"><label class="badge badge-primary">Detail</i></label></a>
                                            @if($data->status=='pengajuan')
                                            <a href="{{url('/dashboard/changestatus/'.$data->id)}}"><label class="badge badge-primary">Terima</i></label></a>
                                            @elseif($data->status=='aktif')
                                            <a href="#"><label class="badge badge-primary">Donasi Aktif</i></label></a>
                                            @else
                                            <label class="badge badge-primary">Donasi Selesai</i></label>
                                            @endif
                                            <a onclick="return confirm('Data akan dihapus!')" href="{{url('/dashboard/deletedonasi/'.$data->id)}}"><label class="badge badge-danger">Hapus</i></label></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
